...
export const addUsersToProducer = async (userIds, procedureId) => {
    const url = `${api_url}/UserProcedureAssignments/AddRemoveUsersToPlan`;
    var command = { UserId: userIds, ProcedureId: procedureId };
    const response = await fetch(url, {
        method: "POST",
        headers: {
            Accept: "application/json",
...
export const getUsersForprocedure = async (procedureId) => {
    const url = `${api_url}/UserProcedureAssignments/GetUsersForProcedure/${procedureId}`;
    const response = await fetch(url, {
        method: "GET",
    });
...
export const RemoveAllUsersForSelectedProcedure = async () => {
    const url = `${api_url}/UserProcedureAssignments/RemoveAllUser`;
    const response = await fetch(url, {
              method: "DELETE",
        headers: {
            Accept: "application/json",
